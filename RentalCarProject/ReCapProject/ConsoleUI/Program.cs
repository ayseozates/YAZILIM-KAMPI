                ...
                case 20:
                    {
                        ...
                        Console.WriteLine("Şirket adını giriniz.");
                        companyName = Console.ReadLine();
                        Customer customer = new Customer { CustomerId = id, UserId = userId, CompanyName = companyName };
                ...
                case 22:
                    {
                        ...
                        Rental rental = new Rental { CarId = carId, CustomerId = customerId, RentalDate = rentDate, ReturnDate = returnDate };
